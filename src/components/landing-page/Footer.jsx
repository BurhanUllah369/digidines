...
const Footer = () => {
  return (
    <footer className="w-full bg-mainColor text-gray-100">
      <section className="w-2/3 mx-auto py-12 flex justify-between gap-8">
        <section className="w-full my-auto text-center">
      ...
      <p className="p-4 text-center bg-gray-950">© 2024 Digi Dines a product of Skytech Cyber Cloud. All rights reserved.</p>
    </footer>
  );
};
